...
public interface ClickLogRepository extends IRepository<ClickLog, String> {
default Page<ClickLog> query(ClickLogSearchDTO dto) {
...
Optional<ClickLog> findTopByClickId(String clickId);
}
